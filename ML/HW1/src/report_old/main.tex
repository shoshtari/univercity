...
\begin{document}
	...
	\begin{minipage}[t]{0.7\textwidth}
		...
		{\huge\textcolor[HTML]{cc6098}{\title\textbf{{یادگیری ماشین }}}}\\
...
\end{pmatrix}
	...
	\begin{latin}
		$
		P_{Y | X_1} = \cfrac{P(X_1 | Y) * P(Y)}{P(X_1)} \Rightarrow P(Y = c | X_1 = 0) = \cfrac{P(X_1 = 0 | Y = c)P(Y = c)}{\sum_{i = 0}^2 P(X_1 = 0 | Y = i)P(Y = i)}
		$
		\\\\
		$
...
\begin{latin}
	$
	X \sim Multinomial(n, p_1, p_2, ..., p_k) \Rightarrow P_X(x_1, x_2, ..., x_k) = \cfrac{n!}{x_1!x_2!x_3!...x_k!} p_1^{x_1}p_2^{x_2}...p_k^{x_k}
	$
\end{latin}
